...
class Settings extends ADMIN_Controller
{
    ...
    public function index()
    {
		...
		$data['headAboutUs'] = $this->Home_admin_model->getValueStore('headAboutUs');
    ...
    private function postChecker()
    {
		...
		if (isset($_POST['headAboutUs'])) {
            $this->Home_admin_model->setValueStore('headAboutUs', $_POST['headAboutUs']);
            $this->session->set_flashdata('resultFooterAboutUs', 'Footer about us text changed!');
            $this->saveHistory('Change footer about us info');
            redirect('admin/settings');
        }
		...
		if (isset($_POST['nomorWa'])) {
            $this->Home_admin_model->setValueStore('nomorWa', $_POST['nomorWa']);
            $this->session->set_flashdata('nomorWa', 'Nomor WhatsApp sudah diganti!');
            $this->saveHistory('Ganti nomor WhatsApp ' . $_POST['nomorWa']);
            redirect('admin/settings');
        }
