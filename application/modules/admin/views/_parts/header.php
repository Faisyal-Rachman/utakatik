                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu">
                                        ...
                                        <div class="input-group custom-search-form">
                                            <form method="GET" action="<?= base_url('admin/products') ?>">
                                                <div class="input-group">
                                                    <input class="form-control" name="search_title" value="<?= isset($_GET['search_title']) ? $_GET['search_title'] : '' ?>" type="text" placeholder="Cari item...">
                                    ...
                                    <li class="header"><b>ECOMMERCE</b></li>
                                    <li><a href="<?= base_url('admin/publish') ?>" <?= urldecode(uri_string()) == 'admin/publish' ? 'class="active"' : '' ?>><i class="fa fa-edit" aria-hidden="true"></i> Publish produk</a></li>
                                    <li><a href="<?= base_url('admin/products') ?>" <?= urldecode(uri_string()) == 'admin/products' ? 'class="active"' : '' ?>><i class="fa fa-files-o" aria-hidden="true"></i> Produk</a></li>
                                    <?php if ($showBrands == 1) { ?>
                                    ...
                                    <?php } ?>
                                    <li><a href="<?= base_url('admin/shopcategories') ?>" <?= urldecode(uri_string()) == 'admin/shopcategories' ? 'class="active"' : '' ?>><i class="fa fa-list-alt" aria-hidden="true"></i> Kategori</a></li>
                                    <li>
                                    ...
                                    if (!empty($textualPages)) {
                                        ...
                                        ?>
                                        <li class="header"><b>FITUR WEB</b></li>
									...
									<li><a href="<?= base_url('admin/galeri') ?>" <?= urldecode(uri_string()) == 'admin/galeri' ? 'class="active"' : '' ?>><i class="fa fa-th" aria-hidden="true"></i>Galeri Kegiatan Tefa</a></li>
                                 ...
                                 <li><a href="<?= base_url('admin/templates') ?>" <?= urldecode(uri_string()) == 'admin/templates' ? 'class="active"' : '' ?>><i class="fa fa-font" aria-hidden="true"></i> Templates</a></li>
                                    <li><a href="<?= base_url('admin/titles') ?>" <?= urldecode(uri_string()) == 'admin/titles' ? 'class="active"' : '' ?>><i class="fa fa-font" aria-hidden="true"></i> Judul / DeskripsiWeb</a></li>
                                    <li><a href="<?= base_url('admin/pages') ?>" <?= urldecode(uri_string()) == 'admin/pages' ? 'class="active"' : '' ?>><i class="fa fa-file" aria-hidden="true"></i> Halaman Aktif</a></li>
                                    <li><a href="<?= base_url('admin/emails') ?>" <?= urldecode(uri_string()) == 'admin/emails' ? 'class="active"' : '' ?>><i class="fa fa-envelope-o" aria-hidden="true"></i> Subscrib Email</a></li>
                                  
                                    <li class="header"><b>PENGATURAN TAMBAHAN</b></li>
                                    ...
                                    <li><a href="<?= base_url('admin/adminusers') ?>" <?= urldecode(uri_string()) == 'admin/adminusers' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> Admin Users</a></li>
                                     <li><a href="<?= base_url('admin/siswa') ?>" <?= urldecode(uri_string()) == 'admin/siswa' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> Siswa</a></li>
                                        <li><a href="<?= base_url('admin/slider') ?>" <?= urldecode(uri_string()) == 'admin/slider' ? 'class="active"' : '' ?>><i class="fa fa-user" aria-hidden="true"></i> Slide Depan</a></li>
                                </ul>
                            </div>
