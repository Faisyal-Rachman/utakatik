<div id="products">
    ...
    ?>
    <h1><img src="<?= base_url('assets/imgs/products-img.png') ?>" class="header-img" style="margin-top:-2px;"> Produk</h1>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <form method="GET" id="searchProductsForm" action="">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Nama produk" type="text" value="<?= isset($_GET['search_title']) ? $_GET['search_title'] : '' ?>" name="search_title">
