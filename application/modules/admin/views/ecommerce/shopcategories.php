<div id="languages">
    <h1><img src="<?= base_url('assets/imgs/categories.jpg') ?>" class="header-img" style="margin-top:-2px;"> Ketegori produk dan galeri</h1> 
    <hr>
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Menambahkan kategori</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <?php } foreach ($languages as $language) { ?>
                            <div class="form-group">
                                <label>Nama (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
                                <input type="text" name="categorie_name[]" class="form-control">
                            </div>
                        <?php } ?>
                        <div class="form-group">
                            <label>Parent kategori <sup>ini akan menjadi sub kategori</sup>:</label>
                            <select class="form-control" name="sub_for">
                                <option value="0">default(Tidak)</option>
                                <?php
                                foreach ($shop_categories as $key_cat => $shop_categorie) {
                                    $aa = '';
                                    foreach ($shop_categorie['info'] as $ff) {
