 ...
 */
$route['default_controller'] = 'service_komputer_tarakan';
...
// Products urls style
$route['kedai-online-(:any)'] = "kedai_online_tarakan";
$route['(:any)_(:num)'] = "kedai_online_tarakan/viewProduct/$2";
$route['baca/(:any)_(:num)'] = "kedai_online_tarakan/viewInfo/$2";
...
$route['(\w{2})/(:any)-(:num)'] = "home/viewGaleri/$3";
$route['shop-galeri_(:num)'] = "home/viewGaleri/$3";

// blog urls style and pagination
$route['kedaionlinetarakan/informasiseputartarakan/(:num)'] = "kedaionlinetarakan/informasiseputartarakan/$1";
 ...
 */
// HOME / LOGIN
$route['admin'] = "admin/service_komputer_tarakan/login";
// ECOMMERCE GROUP
