                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown dropdown-more">
                                        <a class="dropdown-toggle parent" data-toggle="dropdown" href="#">
                                            PROFIL <i class="fa fa-male" aria-hidden="true"></i>	
                                        ...
                                        <ul class="dropdown-menu">                                   
                                            ...
                                            if (!empty($dynPages)) {
                                                ...
                                                ?>
                                                      ...
                                                      <li<?= uri_string() == 'galeri' || uri_string() == MY_LANGUAGE_ABBR . '/galeri' ? ' class="active"' : '' ?>><a href="<?= LANG_URL . '/galeri' ?>">Kedai Olala</a></li>         
                                      
                                    
									
                                    <li<?= uri_string() == 'contacts' || uri_string() == MY_LANGUAGE_ABBR . '/contacts' ? ' class="active"' : '' ?>><a href="<?= LANG_URL . '/contacts' ?>">Hubungi kami <i class="fa fa-phone" aria-hidden="true"></i></a></li>
 
                                </ul > <ul style="list-style:none"; class="social">
