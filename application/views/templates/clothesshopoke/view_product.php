    ...
    <div class="body">
        <div class="row">
                                ...
                                while (($file = readdir($dh)) !== false) {
                                    if (is_file($dir . $file)) {
                                        ...
                                        <div class="col-xs-4 col-sm-6 col-md-4 text-center">
											...
											data-num="<?= $i ?>" class="other-img-preview img-sl img-thumbnail the-image" alt="<?= str_replace('"', "'", $product['title']) ?>">
                                        </div>
                                        <?php
                                        $i++;
                                    }
            ...
            <div class="col-sm-8">
                ...
                <div class="row row-info">
                    <div class="col-sm-6"> <b> <a href="https://api.whatsapp.com/send?phone=<?= $nomorWa ?>&text=Halo%20Admin%20Saya%20Mau%20Order%20Produk" target="_blank"> <i class="fa fa-whatsapp" style="font-size:40px;"></i> WhatsApp <?= $nomorWa ?> </a></b> Pilih tombol ini Anda dapat chat admin untuk pemesanan! </div>
...
<div id="modalImagePreview" class="modal">
    ...
    <div id="caption"> <?= $product['description'] ?></div>
</div>
