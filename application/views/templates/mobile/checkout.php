                    ...
                    <?php } ?>
                                ...
                                <?php foreach ($cartItems['array'] as $item) { ?><ons-list-item>
                                   <ons-row>
                                        ...
                                        <ons-col><a href="<?= LANG_URL . '/' . $item['url'] ?>"><?= $item['title'] ?></a><p>
...
<ons-bottom-toolbar style="position: fixed !important;">
      <ons-tabbar>
       ...
       <button class="tabbar__button" style="color:#ffffff;background: #2979FF;" onclick="document.getElementById('goOrder').submit();">     <div class="tabbar__icon"><ons-icon icon="md-local-laundry-service"></ons-icon> OKE PESAN 
      <ons-icon icon="md-cutlery"></ons-icon>
    </div>
   </button>
      </ons-tabbar>
    </ons-bottom-toolbar>
