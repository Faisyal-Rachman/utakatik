...
<ons-card>
  ...
  <h2>" Profile <?php echo $n; ?> "</h2>
   <ons-list-item>
      ...
      <div class="center">
        <span class="list-item__title"><?php echo $e; ?><?php echo $f; ?></span><span class="list-item__subtitle">Point<font style="color:#21d684;font-weight: bold;"> <i class="zmdi zmdi-label"></i>  <?php echo $uinfo['point']; ?> </font> <br><br><p>
